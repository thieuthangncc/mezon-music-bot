...
@Module({
    providers: [CommandService, StreamCommand, StopstreamCommand, SetupCommand, PlayCommand, RequestCommand, PlaylistCommand, NowCommand, SkipCommand, StopCommand, HelpCommand, GrantPermissionCommand],
